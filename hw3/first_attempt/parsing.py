...
class LentaParser:
    ...
    def __init__(self, *, max_workers: int, outfile_name: str, from_date: str, num_pages: int):
    ...
    def parse_article_html(html: str):
        ...
        topic = doc_tree.find("div", "rubric-header__title")
    ...
    async def _producer(self):
        for date in self.dates_countdown:
            for page in range(1, self.num_pages + 1):
                news_page_url = f"{self._endpoint}/{date}/page/{page}/"
...
def main():
    ...
    parser.add_argument(
        "--num-pages", default=10, type=int, help="number of pages"
    )
    ...
    parser.add_argument(
        ...
        default="01.01.2024",
        type=str,
        help="download news from this date. Example: 01.01.2024",
    )
